...
dbackpacker.run(function ($rootScope) {
    ...
    if (sessionStorage.getItem('packing') == 1) {
        ...
        var DGeneticPacker = new GeneticPacker($rootScope.items, sessionStorage.getItem('maxWeight'), maxValue);
        DGeneticPacker.evolution($rootScope.items.length,1000);
